...
<div id="contribute" class="maxstore-tab-pane">
	...
	<div class="maxstore-tab-pane-half maxstore-tab-pane-first-half">
		...
		<p><strong><?php esc_html_e( 'Found a bug? Want to contribute with a fix or create a new feature?','maxstore'); ?></strong></p>

		<p><?php esc_html_e( 'Support fourm is the place to go!','maxstore' ); ?></p>

		<p>
			<a href="<?php echo esc_url( 'http://support.themes4wp.com/' ); ?>" class="contribute-button button button-primary"><?php printf( esc_html__( '%s support forum', 'maxstore' ), 'MaxStore' ); ?></a>
		</p>
